...
bgImage.src = "./images/background_01.png"; // background.png";
// (2) 게임 시작
...
const OBSTACLE_SPEED = 20; // 4; // 장애물 이동 속도
...
//
/** 3-1 배경 화면 그리기 */
function backgroundImg(bgX) { // 배경화면이 움직이도록
